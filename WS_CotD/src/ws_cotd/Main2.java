...
public class Main2 {
	...
	public static String path2 = "D:\\Workshop\\WeissSchwarz\\FB\\CotD_Web\\se32\\cards\\template.html";
	public static String path3 = "D:\\Workshop\\WeissSchwarz\\FB\\CotD_Web\\se32\\cards\\";
	public static String path4 = "D:\\Workshop\\WeissSchwarz\\FB\\CotD_Web\\se32\\index.html";
	public static String path5 = "D:\\Workshop\\WeissSchwarz\\FB\\CotD_Web\\se32\\index2.html";
		...
		for(int i = 0; i < indexContent.size(); i++){
			for(String ref : newCards){
				if(indexContent.get(i).endsWith(ref)){
					String newLine = fecha + "<a href='./cards/se32_" + ref + ".html'><img src='./images/se32_" + ref + ".png' width=100% height=auto></img></a>PD/SE32-" + ref;
